...
public class HumanResourcesTest {
   ...
   void setUp() throws DuplicateException {
      ...
      humanResources.addStaff(maxMaier);
   ...
   void testAddPerson() throws DuplicateException {
      assertThrows(DuplicateException.class, () -> humanResources.addStaff(maxMaier));

      humanResources.addStaff(petraMueller);
   ...
   void testAddTelephoneNumber() {
      ...
      assertEquals(maxMaier, humanResources.telephoneBook().get(maxMaierPhoneNumber));
   }
